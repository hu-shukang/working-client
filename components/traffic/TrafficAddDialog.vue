...
<script setup lang="ts">
  ...
  import { TrafficAddModel, initTrafficAddModel } from '~/types/traffic.type';
  ...
  const form = reactive<TrafficAddModel>(initTrafficAddModel());
  ...
  const rules = reactive<FormRules<TrafficAddModel>>({
